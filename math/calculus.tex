...
\begin{section}{Partial Differentiation}
  ...
  \begin{section}{Second Derivative Test}
    ...
    \begin{tabular}{l}
      $A = \frac{\partial{f}^2}{\partial^2{x}}@(x_c,y_c)$ \\
      $B = \frac{\partial{f}^2}{\partial{x}\partial{y}}@(x_c,y_c)$ \\
      $C = \frac{\partial{f}^2}{\partial^2{y}}@(x_c,y_c)$ \\
    \end{tabular}
