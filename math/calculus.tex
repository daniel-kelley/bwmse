...
\begin{section}{Dot Product}
  ...
  The scalar value of the dot product is the length of the projection of
  $\vec{B}$ onto $\vec{A}$.
  \begin{align*}
...
\begin{section}{Cross Product}
  \begin{figure}[h!]
    ...
    \end{center}
  \end{figure}
  $\vec{A}\times\vec{B} = \left|A\right|\left|B\right|sin(\theta)\hat{n}$

  The vector value of the cross product is the area of the
  parallelogram formed by $\vec{B}$ and $\vec{A}$ and is the length of
  the vector normal to the plane of the parallelogram following the
  right hand rule.
    \begin{align*}
    \vec{A}\times{B} &=0&&\text{Vectors are parallel.} \\
  \end{align*}
